...
<body>
	<header>
				...
				<div class="col-md-12" style="padding: 0">
					<div class="card border-0">
						<div class="card-body text-center">
							<p class="card-text">
								何らかのエラーが発生いたしました。<br> もう一度入力をお願い致します。
							</p>
						</div>
					</div>
				</div>
		...
		<button type="button" onclick="history.back()" class="btn btn-primary" style="display:block; margin:auto;">戻る</button>
	<footer>
		(C) 豊田農園
